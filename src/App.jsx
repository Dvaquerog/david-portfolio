...
function VennDiagram({ t }) {
  return (
    <svg viewBox="0 0 260 220" width="260" height="220" style={{ display: "block" }}>
      ...
      <circle cx="130" cy="72" r="70" fill={t.accent} fillOpacity="0.85" clipPath="url(#c2)" style={{ clipPath: "url(#c2)" }}/>
      <circle cx="90" cy="148" r="70" fill={t.accent} fillOpacity="0.85" clipPath="url(#c1)" style={{ display: "none" }}/>
  ...
  return (
    <div style={{ background: t.bg, minHeight: "100vh", transition: "all 0.35s ease", color: t.text }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 28px 80px" }}>
        ...
        {/* NAV */}
        <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "28px 0 32px", borderBottom: `0.5px solid ${t.border}`, marginBottom: 64 }}>
...
{/* HERO */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 40, alignItems: "start", marginBottom: 72 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 18, marginBottom: 24 }}>
              <div style={{ width: 64, height: 64, borderRadius: "50%", background: t.accentFaint, border: `1px solid ${t.accentBorder}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, fontWeight: 500, color: t.accent, fontFamily: sans, flexShrink: 0, overflow: "hidden" }}>
                <img src="/david.jpg" alt="David Vaquero" width={64} height={64} style={{ borderRadius: "50%", objectFit: "cover", objectPosition: "center top" }}/>
              </div>
              <div>
                <p style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted, marginBottom: 4 }}>Lead Business Analyst</p>
                <p style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>Category Manager · MSc AI (in progress)</p>
              </div>
            </div>
            <h1 style={{ fontFamily: serif, fontSize: 42, fontWeight: 400, color: t.text, lineHeight: 1.1, marginBottom: 20, letterSpacing: "-0.02em" }}>
              David Vaquero<br />
              <span style={{ color: t.accent }}>García</span>
            </h1>
            <p style={{ fontFamily: serif, fontSize: 17, fontStyle: "italic", color: t.textSub, lineHeight: 1.6, borderLeft: `2px solid ${t.accent}`, paddingLeft: 16, maxWidth: 440 }}>
              Simplifying data.<br />
              <span style={{ color: t.accent }}>Amplifying impact.</span>
            </p>

            {/* PRIMARY CTA — momento álgido tras el claim */}
            <div style={{ display: "flex", gap: 12, marginTop: 28, flexWrap: "wrap" }}>
              <a
                ...
                style={{
                  ...
                  background: t.accent, color: "#F0EDE8",
              ...
              <a
                href="https://davidvaquerog.wordpress.com/wp-content/uploads/2025/01/cv-david-2024-pdf.pdf"
                target="_blank"
                rel="noreferrer"
                style={{
                  display: "inline-flex", alignItems: "center", gap: 8,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 56 }}>
          ...
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>About</span>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <div style={{ width: 32, height: 1, background: t.accent, opacity: 0.5 }}/>
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>At a glance</span>
          <div style={{ flex: 1, height: "0.5px", background: t.border }}/>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(108px, 1fr))", gap: 10, marginBottom: 64 }}>
          {STATS.map((st, i) => (
            <div key={i} style={{
              background: st.highlight ? t.accentFaint : t.card,
              border: `0.5px solid ${st.highlight ? t.accentBorder : t.border}`,
              borderRadius: 10,
              padding: "18px 12px",
              textAlign: "center",
            }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <div style={{ width: 32, height: 1, background: t.accent, opacity: 0.5 }}/>
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>User lifecycle coverage</span>
          <div style={{ flex: 1, height: "0.5px", background: t.border }}/>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <div style={{ width: 32, height: 1, background: t.accent, opacity: 0.5 }}/>
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>What I bring</span>
          <div style={{ flex: 1, height: "0.5px", background: t.border }}/>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(165px, 1fr))", gap: 12, marginBottom: 64 }}>
          {CARDS.map((card, i) => (
            <div key={i} style={{
              background: card.inProgress ? t.warnBg : t.card,
              border: `0.5px solid ${card.inProgress ? t.warnBorder : t.border}`,
              borderRadius: 12,
              padding: "20px 18px",
              display: "flex",
              ...
              <div style={{ fontFamily: sans, fontSize: 10, fontWeight: 600, letterSpacing: "0.14em", color: card.inProgress ? t.warn : t.accent, opacity: card.inProgress ? 1 : 0.7 }}>
                {card.num}
              </div>
              <div style={{ fontFamily: sans, fontSize: 13, fontWeight: 500, color: card.inProgress ? t.warn : t.text, lineHeight: 1.3 }}>
                {card.title}
              </div>
              <div style={{ fontFamily: sans, fontSize: 12, color: card.inProgress ? t.warn : t.textSub, lineHeight: 1.6, opacity: card.inProgress ? 0.85 : 1, flex: 1 }}>
                {card.body}
              </div>
              {card.inProgress && (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <div style={{ width: 32, height: 1, background: t.accent, opacity: 0.5 }}/>
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>How I lead</span>
          <div style={{ flex: 1, height: "0.5px", background: t.border }}/>
        </div>
        <div style={{ marginBottom: 64 }}>
          {LEADERSHIP.map((item, i) => (
            <div key={i} style={{
              ...
              gap: "0 24px",
              padding: "20px 0",
              borderBottom: i < LEADERSHIP.length - 1 ? `0.5px solid ${t.borderFaint}` : "none",
              alignItems: "start",
            }}>
              ...
              <div>
                <div style={{ fontFamily: serif, fontSize: 15, fontWeight: 400, color: t.text, marginBottom: 6, fontStyle: "italic" }}>
                  {item.title}
                </div>
                <div style={{ fontFamily: sans, fontSize: 13, color: t.textSub, lineHeight: 1.7 }}>
                  {item.body}
                </div>
              </div>
            </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <div style={{ width: 32, height: 1, background: t.accent, opacity: 0.5 }}/>
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>International footprint</span>
          <div style={{ flex: 1, height: "0.5px", background: t.border }}/>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
          <div style={{ width: 32, height: 1, background: t.accent, opacity: 0.5 }}/>
          <span style={{ fontFamily: sans, fontSize: 10, letterSpacing: "0.16em", textTransform: "uppercase", color: t.textMuted }}>Areas</span>
          <div style={{ flex: 1, height: "0.5px", background: t.border }}/>
        </div>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 7, marginBottom: 64 }}>
          {PILLS_ACCENT.map((p, i) => (
            <span key={i} style={{ fontFamily: sans, fontSize: 12, padding: "6px 14px", borderRadius: 999, border: `0.5px solid ${t.accentBorder}`, color: t.accentText, background: t.accentFaint }}>
              {p}
            </span>
          ))}
          {PILLS_PLAIN.map((p, i) => (
            <span key={i} style={{ fontFamily: sans, fontSize: 12, padding: "6px 14px", borderRadius: 999, border: `0.5px solid ${t.border}`, color: t.textSub, background: t.card }}>
              {p}
            </span>
          ))}
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <a href="https://davidvaquerog.wordpress.com/wp-content/uploads/2025/01/cv-david-2024-pdf.pdf" target="_blank" rel="noreferrer"
            style={{ fontFamily: sans, fontSize: 11, letterSpacing: "0.08em", color: t.textMuted, textDecoration: "none", textTransform: "uppercase" }}>
            ↓ CV
          </a>
